...
**格式要求**：
- ✅ 正确：从availableContinents选择大陆名，从availableLocations选择地点名，用·连接
- ❌ 错误：编造不在列表中的大陆名或地点名
- ❌ 错误：使用未在availableContinents中出现的大陆名
...
*   内容:
    *   **位置设置规范（重要）**：
        ...
        *   **格式要求**：
            - ✅ 正确：选择availableContinents中的大陆名，选择availableLocations中的地点名，用·连接
            - ❌ 错误：添加中间层级（如"大陆·区域·地点"）
            - ❌ 错误：使用未在列表中出现的大陆名或地点名
