...
const CHARACTER_INIT_RULES = [
  ...
  '',
  '## 3.1 坐标设置 ⚠️ 必须完成',
  '**必须**在设置位置描述的同时，设置玩家的x, y坐标（虚拟坐标系）。',
  '坐标应基于地图上可用地点的坐标或从地点列表中选择具有coordinates的地点。',
  '命令示例: ',
  '  {"action":"set","key":"玩家角色状态.位置.x","value":500}',
  '  {"action":"set","key":"玩家角色状态.位置.y","value":300}',
  '坐标范围通常在 0-1000 之间（取决于地图配置）。',
  '',
  '## 3.2 命名风格一致性 (高优先级)',
  ...
  '## 6.1 NPC境界约束 (高优先级)',
  '**根据世界背景严格限制NPC境界**：',
  '- 地球/现代背景: 初始NPC境界应为"凡人"或"练气初期~中期"，最好不允许出现筑基及以上境界！',
  '- 低灵气世界: 初始NPC最高"练气后期"，极少数可"筑基初期"',
  '- 普通仙侠世界: 可适当放宽',
  '- 高战力世界: 可适当提高境界上限',
  '**关键**: 人物关系中的NPC境界必须与世界设定匹配！不要随意创建高境界NPC，根据世界背景和那些世界势力判断！',
  '',
  '## 7. 叙事要求',
