...
\`\`\`json
{
  ...
  "tavern_commands": [
    {"action": "set", "key": "位置.描述", "value": "大陆名·区域名·地点名"},
...
*   **最高优先级规则 2：随机选项必须具体化**
    ...
    *   **随机灵根处理**：从可用灵根中随机选择一个具体的灵根（如"火灵根·上品"、"混沌灵根·神品"等），并在故事中详细描述其特性和异象。
    *   **随机出生处理**：从可用出身中随机选择一个具体的背景（如"山野遗孤"、"书香门第"等），并在故事中体现其带来的影响。
...
*   内容:
    ...
    *   **物品**: **必须**在背包中添加 2-5 件符合背景的初始物品，包括：
        ...
        *   ⚠️ **品质限制**: 开局物品品质普通出身以"凡"品为主、家族或小宗门弟子"黄"品封顶，大宗弟子"玄"品封顶，特殊开局可能有，地品、天品、甚至是仙品
