...
export const IN_GAME_MESSAGE_PROMPT = [
  ...
  '```json',
  '{',
  '  "text": "⚠️ 必须1500-3000字的详细叙述内容，包含细致的环境描写、人物对话、心理活动、动作描写等",',
  ...
  '- tavern_commands: 基于state_changes生成精确的修改指令（使用简化路径）',
