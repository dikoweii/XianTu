...
## 4. NPC物品与财富生成（重要）
**核心规则：** 生成NPC时，应根据其身份、境界、职业合理配置背包物品，让世界更真实。

**生成原则：**
- **普通NPC**（凡人、练气期）：少量灵石（0-50下品），1-2件凡品/黄品物品
- **修士NPC**（筑基期及以上）：适量灵石（根据境界），2-4件物品（功法、丹药、材料等）
- **商人NPC**：大量灵石和商品物品
- **宗门长老/掌门**：丰富的灵石和高品质物品
- **敌对NPC**：战斗后可掉落物品
...
**操作示例：**
\`\`\`json
{"action":"set","key":"人物关系.张三.背包.灵石","value":{"下品":100,"中品":10,"上品":0,"极品":0}}
{"action":"set","key":"人物关系.张三.背包.物品.pill_001","value":{"物品ID":"pill_001","名称":"聚气丹","类型":"丹药","品质":{"quality":"黄","grade":3},"数量":5,"描述":"辅助练气期修炼的丹药"}}
\`\`\`
`.trim()
